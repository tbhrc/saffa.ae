...
(function () {
  ...
  <nav class="nav" aria-label="Main navigation">
    <div class="nav-inner">
      ...
      <div class="nav-links">
        ...
        <a href="https://chat.whatsapp.com/JoinSaffasUAE" target="_blank" rel="noopener noreferrer" class="btn btn-wa btn-sm nav-cta">
  ...
  <div id="mobile-menu" class="mobile-menu" role="dialog" aria-modal="true" aria-label="Navigation menu">
    ...
    <div class="mobile-menu-footer">
      <a href="https://chat.whatsapp.com/JoinSaffasUAE" target="_blank" rel="noopener noreferrer" class="btn btn-wa" style="width:100%;justify-content:center">
